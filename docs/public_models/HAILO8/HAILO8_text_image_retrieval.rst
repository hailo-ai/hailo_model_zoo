...
.. list-table::
   ...
   * - clip_text_encoder_resnet50x4 
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.13.0/hailo8/clip_text_encoder_resnet50x4.hef>`_    
   * - clip_text_encoder_vit_large   
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.13.0/hailo8/clip_text_encoder_vit_large.hef>`_  
