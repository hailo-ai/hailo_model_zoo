...
* Install HailoRT (optional). Required only if you want to run on Hailo's. In case you are not Hailo customer please contact `hailo.ai <https://hailo.ai/company-overview/contact-us/>`_
