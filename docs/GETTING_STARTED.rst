...
* Hailo Dataflow Compiler v5.3.0 (Obtain from `hailo.ai <http://hailo.ai>`_\ )
* HailoRT v5.3.0 (Obtain from `hailo.ai <http://hailo.ai>`_\ ) - required only for inference on Hailo-10H.
