...
Public Pre-Trained Models - Object Detection Hailo15H
=====================================================
...
.. list-table::
   ...
   * - yolov5m_wo_spp |rocket|
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo15h/yolov5m_wo_spp_nv12.hef>`_
   * - yolov5s  |star|
     - 35.33
     - 33.98
     - 162
