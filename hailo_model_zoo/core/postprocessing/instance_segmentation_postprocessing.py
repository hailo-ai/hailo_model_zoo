...
def _organize_hpp_yolov5_seg_outputs(outputs, img_dims):
    ...
    # Emulator outputs 4D (batch, 1, features, num_proposals) - squeeze and transpose needed.
    # Hardware NMS outputs 3D (batch, num_proposals, features) - already in the right layout.
    if outputs.ndim == 4:
        num_of_proposals = outputs.shape[-1]
