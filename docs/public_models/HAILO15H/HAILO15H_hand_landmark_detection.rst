...
Public Pre-Trained Models - Hand Landmark detection HAILO15H
============================================================
...
.. list-table::
   ...
   * - hand_landmark_lite
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo15h/hand_landmark_lite.hef>`_
     - None
