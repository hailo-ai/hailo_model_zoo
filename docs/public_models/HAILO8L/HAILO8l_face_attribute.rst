...
Public Pre-Trained Models - Face Attribute Hailo8L
==================================================
...
.. list-table::
   ...
   * - face_attr_resnet_v1_18
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo8l/face_attr_resnet_v1_18.hef>`_
