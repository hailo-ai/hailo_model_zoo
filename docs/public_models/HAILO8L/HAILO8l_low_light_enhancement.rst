...
Public Pre-Trained Models - Low Light Enhancement Hailo8L
=========================================================
...
.. list-table::
   ...
   * - zero_dce
     ...
     - `link <Internal>`_
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo8l/zero_dce.hef>`_
   * - zero_dce_pp
     - 15.95
     - 15.82
     - 34
     ...
     - `link <Internal>`_
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo8l/zero_dce_pp.hef>`_
