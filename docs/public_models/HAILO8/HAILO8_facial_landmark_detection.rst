...
.. list-table::
   ...
   * - tddfa_mobilenet_v1  |star| 
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.14.0/hailo8/tddfa_mobilenet_v1.hef>`_
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.14.0/hailo8/tddfa_mobilenet_v1_profiler_results_compiled.html>`_
