...
TF_RECORD_LOC = {
    "calib": "models_files/kitti_stereo/kitti_stereo_calib.tfrecord",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            "examples:\n"
            "python create_kitti_stereo_tfrecord.py calib --data" + "<TRAIN_DIR>\n"
            "python create_kitti_stereo_tfrecord.py val " + "--data <VALIDATION_DIR>\n"
        ),
    )
