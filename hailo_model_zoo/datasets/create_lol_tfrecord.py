...
DESCRIPTION = "Create tfrecord for Low Light Enhancement task from LOL dataset (low and high light images).\n" +\
...
TF_RECORD_LOC = {'val': 'models_files/LowLightEnhancement/LOL/{}/hailo_val_set_lol.tfrecord',
...
if __name__ == '__main__':
    ...
    assert args.type in TF_RECORD_TYPE, \
        'Please provide which kind of tfrecord to create {}'.format(TF_RECORD_TYPE)
