...
.. list-table::
   ...
   * - fast_depth  |star|
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.12.0/hailo8l/fast_depth.hef>`_
   * - scdepthv3
     - 0.48
     - 0.51
     - 118
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.12.0/hailo8l/scdepthv3.hef>`_
