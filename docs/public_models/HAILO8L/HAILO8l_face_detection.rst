...
Public Pre-Trained Models - Face Detection Hailo8L
==================================================
...
.. list-table::
   ...
   * - scrfd_500m
     ...
     - `link <https://github.com/deepinsight/insightface>`_
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo8l/scrfd_500m.hef>`_
