...
Public Pre-Trained Models - Facial Landmark Detection HAILO15M
==============================================================
...
.. list-table::
   ...
   * - tddfa_mobilenet_v1  |star|
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo15m/tddfa_mobilenet_v1.hef>`_
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo15m/tddfa_mobilenet_v1_nv12.hef>`_
