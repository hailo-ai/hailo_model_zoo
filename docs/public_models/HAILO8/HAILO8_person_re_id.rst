...
.. list-table::
   ...
   * - osnet_x1_0   
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.13.0/hailo8/osnet_x1_0.hef>`_     
   * - repvgg_a0_person_reid_512  |star| 
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.13.0/hailo8/repvgg_a0_person_reid_512.hef>`_
