...
Public Pre-Trained Models - Person Attribute Hailo8L
====================================================
...
.. list-table::
   ...
   * - person_attr_resnet_v1_18
     ...
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo8l/person_attr_resnet_v1_18.hef>`_
