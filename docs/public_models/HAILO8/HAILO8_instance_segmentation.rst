...
Public Pre-Trained Models - Instance Segmentation HAILO8
========================================================
...
.. list-table::
   ...
   * - yolov8s_seg
     ...
     - `link <https://github.com/ultralytics/ultralytics>`_
     - `download <https://hailo-model-zoo.s3.eu-west-2.amazonaws.com/ModelZoo/Compiled/v2.11.0/hailo8/yolov8s_seg.hef>`_
