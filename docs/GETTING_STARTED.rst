...
* Hailo Dataflow Compiler v3.18.0 (Obtain from `hailo.ai <http://hailo.ai>`_\ )
* HailoRT 4.8.0 (Obtain from `hailo.ai <http://hailo.ai>`_\ ) - required only for inference on Hailo-8.
